...
recorder Node -file [pwd]\\outputs\\{filename}.txt  -time -node 14 -dof 2 disp


integrator EQPath {arc_length} 9 node -dof 2 -tags 14
...
while {$i<$steps && $ret==0} {
	...
	puts "[expr [getTime]] [expr [nodeDisp 14 2]]"
...
lush  $fileID       // flush any output that has been buffered    
